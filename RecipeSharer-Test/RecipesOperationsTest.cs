...
public class RecipeOperationsTests
{
    ...
    public void AddRecipeTestAddsValidRecipe()
    {
        ...
        Recipe recipe = new Recipe(new User("testperson", "testpwd"), "Chocolate Cake", "Delicious chocolate cake recipe", TimeSpan.FromMinutes(30), TimeSpan.FromMinutes(45), 8);
    ...
    public void AddRecipeTestThrowsExceptionWhenRecipeNameIsMissing()
    {
        // Arrange
        RecipeOperations recipeOperations = new RecipeOperations();
        Recipe recipe = new Recipe(new User("testperson", "testpwd"), null, "Delicious chocolate cake recipe", TimeSpan.FromMinutes(30), TimeSpan.FromMinutes(45), 8);
    ...
    public void UpdateRecipeTestUpdatesExistingRecipeWithValidDetails()
    {
        // Arrange
        RecipeOperations recipeOperations = new RecipeOperations();
        Recipe existingRecipe = new Recipe(new User("testperson", "testpwd"), "Chocolate Cake", "Delicious chocolate cake recipe", TimeSpan.FromMinutes(30), TimeSpan.FromMinutes(45), 8);
        ...
        // Assert
        Assert.Equals(newDetails.Name, existingRecipe.Name);
        Assert.Equals(newDetails.ShortDescription, existingRecipe.ShortDescription);
        Assert.Equals(newDetails.PreparationTime, existingRecipe.PreparationTime);
        Assert.Equals(newDetails.CookingTime, existingRecipe.CookingTime);
        Assert.Equals(newDetails.TotalTime, existingRecipe.TotalTime);
        Assert.Equals(newDetails.Servings, existingRecipe.Servings);
        Assert.Equals(newDetails.Steps, existingRecipe.Steps);
        Assert.Equals(newDetails.Ingredients, existingRecipe.Ingredients);
    ...
    public void UpdateRecipeTestThrowsArgumentExceptionWhenNewOwnerIsDifferent()
    {
        ...
        RecipeOperations recipeOperations = new RecipeOperations();
        Recipe existingRecipe = new Recipe(new User("testperson", "testpwd"), "Chocolate Cake", "Delicious chocolate cake recipe", TimeSpan.FromMinutes(30), TimeSpan.FromMinutes(45), 8);
        Recipe newDetails = new Recipe(new User("testperson2", "testpwd2"), "Vanilla Cake", "Delicious vanilla cake recipe", TimeSpan.FromMinutes(25), TimeSpan.FromMinutes(40), 10);
    ...
    public void UpdateRecipeTestThrowsArgumentNullExceptionWhenExistingRecipeIsNull()
    {
        // Arrange
        RecipeOperations recipeOperations = new RecipeOperations();
        Recipe newDetails = new Recipe(new User("testperson", "testpwd"), "Vanilla Cake", "Delicious vanilla cake recipe", TimeSpan.FromMinutes(25), TimeSpan.FromMinutes(40), 10);

        // Act and Assert
        Assert.ThrowsException<ArgumentNullException>(() => recipeOperations.UpdateRecipe(null, newDetails));
    }
    ...
    public void UpdateRecipeTestThrowsArgumentNullExceptionWhenNewDetailsIsNull()
    {
        ...
        // Act and Assert
        Assert.ThrowsException<ArgumentNullException>(() => recipeOperations.UpdateRecipe(existingRecipe, null));
    }
}
